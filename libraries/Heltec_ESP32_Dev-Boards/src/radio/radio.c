...
RTC_DATA_ATTR uint8_t MaxPayloadLength = 0xFF;

RTC_DATA_ATTR uint32_t TxTimeout = 0;
RTC_DATA_ATTR uint32_t RxTimeout = 0;

RTC_DATA_ATTR bool RxContinuous = false;


PacketStatus_t RadioPktStatus;
uint8_t RadioRxPayload[255];

RTC_DATA_ATTR bool IrqFired = false;
 ...
 */
void IRAM_ATTR RadioOnTxTimeoutIrq( void );

/*!
 * \brief Rx timeout timer callback
 */
void IRAM_ATTR RadioOnRxTimeoutIrq( void );

/*!
 * \brief Cad timeout timer callback
 */
void IRAM_ATTR RadioOnCadTimeoutIrq( void );
/*
 ...
 * Tx and Rx timers
 */
RTC_DATA_ATTR TimerEvent_t TxTimeoutTimer;
RTC_DATA_ATTR TimerEvent_t RxTimeoutTimer;
RTC_DATA_ATTR TimerEvent_t CadTimeoutTimer;
